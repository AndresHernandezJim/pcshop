...
@section('content')
    ...
    <div class="nav-wrapper">
      <div class="col s12">
        ...
        <a href="#!" class="breadcrumb">Nueva SubCategoria</a>
      </div>
    </div>
  </nav>
   <div class="container">
     <center><h3>Nueva SubCategoria para {{$idsc->nombre}}</h3></center>
      <hr>
      <form class="col s12" method="POST" action="/administrador/new/subcat2/{{$idsc->id}}">
       {{ csrf_field() }}
       <div class="row">
